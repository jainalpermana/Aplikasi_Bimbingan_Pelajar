            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="/identifikasi">
                                    <div class="form-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($Identifikasi as $i)
                                            <tr>
                                                <td>{{ $i -> hari_tanggal }}</td>
                                                <td>{{ $i -> nama }}</td>
                                                <td>{{ $i -> kelas }}</td>
                                                <td>{{ $i -> jenis_masalah }}</td>
                                                <td>
                                                <a type="button" class="btn btn-primary" href="/identifikasi/{{$i->id}}/edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true">EDIT</span></a>
                                                
                                                <a type="button" class="btn btn-primary" href="/identifikasi/{{$i->id}}/"><span class="glyphicon glyphicon-cog" aria-hidden="true">DETAIL</span></a>
                                                

                                                <form action="/identifikasi/{{$i->id}}" method="post">
